        ...
        while t < endT:
            ...
            for k in range(len(p2De)):           
                ...
                if p2De[k-1,5]>bandgap:
                    ...
                    sec1=1 ## change back random.randint(0,1)
                    ...
                    if r<=1:
                        ...
                        p2De[k-1,5]=p2De[k-1,5]- p2De[k-1,5]+0.1 ##random.uniform(bandgap,p2De[k-1,5])*happ*selc[0] #e-e scattering
                        p2De[k-1,5]=p2De[k-1,5]- random.uniform(0,1.27)*happ*selc[1] #e-h scattering
                     
                    else:
                        happ=1
                        p2De[k-1,5]=p2De[k-1,5]-np.minimum(int(r),int(p2De[k-1,5]/bandgap))*p2De[k-1,5]+0.1 ##*random.uniform(bandgap,p2De[k-1,5])*selc[0]      e-e scattering *int(mfp/(eemfp(p2De[k-1,5]-bandgap)/10))
